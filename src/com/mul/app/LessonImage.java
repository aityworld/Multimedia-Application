 ...
 */
public class LessonImage extends JPanel implements ImageObserver {
    ...
    public LessonImage(String img,String bgd) {
        setBackground(Color.black);
        clouds = getDemoImage(bgd);
        agif = getDemoImage(img);
    ...
    public static void main(String argv[]) {
        final LessonImage demo = new LessonImage("duke.running.gif","clouds.jpg");
